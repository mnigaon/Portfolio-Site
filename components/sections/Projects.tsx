            ...
            <div className="flex flex-col gap-0 border-t border-white/5">
                {portfolio.projects.map((project, i) => (
                    <motion.article
                        ...
                        viewport={{ once: true }}
                        variants={fadeUp}
                        className="grid grid-cols-1 lg:grid-cols-[1fr_1.5fr] gap-12 items-start py-12 border-b border-white/5 group"
                    >
                        <div className="aspect-[16/10] bg-[var(--surface)] border border-white/5 rounded overflow-hidden relative transition-colors duration-300 group-hover:border-[#00e5b44d]">
